...
export const monsterStats: MonsterStatsMap = {
  ...
  C1: {
    ...
    props: {
      speed: [2.2],
      health: [2000, 2200, 2400, 2600, 2800, 3000],
      damage: [600, 650, 700, 750, 800, 850],
      cTime: [15, 10, 8, 7, 6, 5],
      cResource: [25, 45, 67, 80, 100, 125],
  ...
  C2: {
    ...
    props: {
      speed: [2.4],
      health: [10000, 11000, 13000, 14500, 16000, 18000],
      damage: [150, 150, 200, 250, 300, 350],
      cTime: [15, 16],
      cResource: [50, 90, 135, 180, 210, 250],
      cStorage: [10],
      bucket: [10],
      targetGroup: [4],
      hTime: [5],
  ...
  C4: {
    ...
    props: {
      speed: [2.3],
      health: [2000, 2000, 2000, 2000, 2200, 2400],
      damage: [3000, 3300, 3800, 4300, 4700, 5200],
      cTime: [100, 100, 100, 100, 90, 90],
      cResource: [150, 225, 337, 480, 720, 1000],
      cStorage: [20],
      bucket: [20],
      targetGroup: [1],
  ...
  C6: {
    ...
    props: {
      speed: [2.2],
      health: [20000, 21000, 22000, 23000, 25000, 28000],
      damage: [50, 60, 70, 80, 95, 110],
      cTime: [100, 100, 90],
      cResource: [500, 562, 844, 1120, 1600, 2400],
      cStorage: [20],
      bucket: [20],
      targetGroup: [4],
      hTime: [30, 30, 27],
  ...
  C7: {
    ...
    props: {
      speed: [1],
      health: [5000, 5500, 6000, 6500, 7500, 9000],
      damage: [2000, 2500, 3000, 3500, 4000, 4500],
      cTime: [225, 225, 225, 225, 180, 180],
      cResource: [250, 450, 675, 875, 1120, 1440],
      cStorage: [20],
      bucket: [20],
      targetGroup: [1],
